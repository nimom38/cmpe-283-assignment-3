...
/* Assignment 2 Changes Start */
extern u32 total_exits;
extern u64 total_time_spent_on_exits;
/* Assignment 2 Changes End */

/* Assignment 3 Changes Start */
extern u32 exit_count[69];
extern u64 exit_duration[69];
...
static int __vmx_handle_exit(struct kvm_vcpu *vcpu, fastpath_t exit_fastpath)
{
	...
	/* CMPE283 Assignment 2 & 3 Changes Start */
  u64 start_time;
	u64 overall_time;
	int exit_handler;
  ...
  if (exit_reason.basic <= 69) {
	...
	/* CMPE283 Assignment 2 & 3 Changes End */
  ...
  overall_time = rdtsc() - start_time;
	total_time_spent_on_exits = overall_time  + total_time_spent_on_exits;
  exit_duration[(int)exit_handler_index] = (overall_time + exit_duration[(int)exit_handler_index]);
